...
public class Description extends AppCompatActivity {
    ...
    private void getInfo() {
        String Dname = "Neem";
        String Ddesc = "Neem is considered to be a pharmacy in its own right in India, where every part of the plant is used medicinally. It contains a number of medically active substances including  bitters and flavonoids. It is one of the most important detoxicants in Ayurvedic medicine. It is a bitter, tonic herb that acts as an alterative, clearing toxins, reducing inflammation, lowering fevers, promoting healing and generally improving bodily functions.";
        String Dsol = "Extracts can be made from leaves and other tissues, but the seeds contain the highest concentrations of the compound . It acts as an insect repellent, inhibiting feeding, and disrupting insect growth,";
        name.setText(Dname);
        desc.setText(Ddesc);
        sol.setText(Dsol);
        //display("1", Dname, Ddesc, Dsol);
    }
